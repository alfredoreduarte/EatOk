...
- (MenuCollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	...
	//cell.backgroundColor = [UIColor colorWithRed:.1*(long)indexPath.row green:.7 blue:.4*((long)indexPath.row+1) alpha:1];
	if(indexPath.row%2){
		cell.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:.18];
	}else{
		cell.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:.36];
	}
